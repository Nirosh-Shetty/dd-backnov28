...
const fs = require('fs').promises; // Use async for better error handling
...
async function migrateData() {
    ...
    try {
        ...
        // Read the file
        const sourceFileContent = await fs.readFile(filePath, 'utf8');
        console.log('File read successfully, length:', sourceFileContent.length);
        // Connect to MongoDB
